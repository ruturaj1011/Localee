...
// get service details
app.get("/vendor/:id/:serviceId", async (req, res) => {
    try {
...
app.delete("/vendor/:vendorId/services/:serviceId/delete", async (req, res) => {
  try {
...
app.put("/vendor/:vendorId/services/:serviceId/edit", upload.array("images", 6), async (req, res) => {
    try {
      const { vendorId, serviceId } = req.params;
